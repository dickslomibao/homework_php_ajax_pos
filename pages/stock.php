...
<div class="maxw" style="padding: 10px;">
    <div class="header-part">
        ...
        <button class="btn-add" data-bs-toggle="modal" data-bs-target="#addModal">Add Stock</button>
    </div>
    <div class="search">
        <div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-container">
                    <label class="my-label" style="font-size: 16px;">Product:</label>
                    <select class="my-form" style="padding: 8px;border:1px solid rgba(0,0,0,.3);border-radius:5px" id="product">
                    </select>
                </div>

                <div class="input-container">
                    <label class="my-label" style="font-size: 16px;">Stock:</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="input-container">
                    <label class="my-label" style="font-size: 16px;">Stock:</label>
                    <input type="number" class="my-form" id="editstock" placeholder="" style="padding: 8px ;">
                    <span id="editstock-error" style="color:red"></span>
                </div>
            </div>
            <div class="modal-footer">
